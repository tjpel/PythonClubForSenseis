...
#load music/sounds
game_music = mixer.music.load('pizza-music.ogg')
lose_sound = mixer.Sound('gameover_sound.wav')
win_sound = mixer.Sound('youwin_sound.wav')
vampire_kill_sound = mixer.Sound('killvampire_sound.wav')
bad_review_sound = mixer.Sound('badreview_sound.wav')
    ...
    def update(self, game_window, counters):
        ...
        if self.health <= 0 or self.rect.x <= 100:
            ...
            if self.rect.x <= 100:
                ...
                bad_review_sound.play()
            else:
                vampire_kill_sound.play()
        else:
